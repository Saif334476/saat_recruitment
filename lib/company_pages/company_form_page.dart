              ...
              child: cupertinoButtonWidget("Next", () async {
                if (_formKey.currentState!.validate()) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CompanyVerificationPage(name: _companyName.text, location: _location.text, industry: _selectedIndustry, email:widget.emailController!.toString(), companySize: _selectedCompanySize),
                    ),
                  );
                }
              }),
